<?php
/*
Plugin Name:     Parcel Address Checkout Autocomplete for WooCommerce
Plugin URI:      https://picwa.co.nz/picwa-projects/
Description:     Allows your customers to autocomplete billing and shipping addresses on the checkout page using the NZpost ParcelAddress API. The ParcelAddress API enables search for international and domestic addresses.
Author:          PICWA TEAM
Author URI:      https://picwa.co.nz
Version:         2.0.0
License: 		GPLv3
...
function pacaw_address_api_js(){
	...
	if (is_checkout()){	  
		wp_enqueue_script('pacaw_api_js',PACAW_PLUGIN_URL.'/js/pacaw_ajax.js');
